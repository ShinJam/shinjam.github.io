...
"use strict";var e=n(require("@babel/runtime-corejs3/core-js-stable/parse-int")),t=n(require("@babel/runtime-corejs3/core-js-stable/instance/sort")),r=n(require("@babel/runtime-corejs3/core-js-stable/instance/map"));function n(e){return e&&e.__esModule?e:{default:e}}!function(n){function u(t){4==t.length&&(t=(0,r.default)(jQuery).call(jQuery,/\w+/.exec(t),function(e){return e+e}).join(""));var n=/(\w{2})(\w{2})(\w{2})/.exec(t);return[(0,e.default)(n[1],16),(0,e.default)(n[2],16),(0,e.default)(n[3],16)]}function a(e,t,n){var a,i=(0,r.default)(jQuery).call(jQuery,u(e.start),function(e,r){var u=Math.round(e+t[r]*n);return u>255?u=255:u<0&&(u=0),u});return a=i,"#"+(0,r.default)(jQuery).call(jQuery,a,function(e){var t=e.toString(16);return t=1==t.length?"0"+t:t}).join("")}function i(e,t){return e-t}n.fn.tagcloud=function(e){var l,c,s=(0,r.default)(l=this).call(l,function(){return n(this).attr("rel")}),o=(s=(0,t.default)(c=jQuery.makeArray(s)).call(c,i))[0],f=s.pop()-o;0===f&&(f=1);var d=(e.size.end-e.size.start)/f,j=function(e,t){return(0,r.default)(jQuery).call(jQuery,u(e.end),function(r,n){return(r-u(e.start)[n])/t})}(e.color,f);return this.each(function(){var t=n(this).attr("rel")-o;e.size&&n(this).css({"font-size":e.size.start+t*d+e.size.unit}),e.color&&n(this).css({backgroundColor:a(e.color,j,t)})})},n.fn.tagcloud.defaults={size:{start:14,end:18,unit:"pt"}}}(jQuery);
