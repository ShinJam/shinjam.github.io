    ...
    <>
      ...
      <Layout>
        ...
        {post.frontmatter.cover && (
          <PostHeroContainer>
            <Img fluid={post.frontmatter.cover.childImageSharp.fluid}  className="img"/>
            {post.frontmatter.coverAnnotation && (
              <PostHeroAnnotation>{post.frontmatter.coverAnnotation}</PostHeroAnnotation>
            )}
          </PostHeroContainer>
        )}
        <PostBody dangerouslySetInnerHTML={{ __html: post.html }}></PostBody>
      </Layout>
    </>
  )
}
